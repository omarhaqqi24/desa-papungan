...
<body class="mytheme font-jakarta antialiased">
    ...
    <div class="mt-40 space-y-20 md:px-0"> </div>
        {{-- Produk yang diambil dari BelanjaController::show() --}}
        <div class="px-5 md:px-10 mt-10 space-y-10">
            <x-cardSubjudul jenisJudul="Katalog Produk" judul="{{ $product['name'] }}"
                deskripsi="" />

        <div class="container mx-auto px-5 md:px-10 py-10 flex flex-col md:flex-row gap-10">
        ...
        <div class="container mx-auto px-5 md:px-10 py-10">
            <div class="mt-5 space-y-10 md:px-0">
        ...
        @forelse ($otherProducts as $otherProduct) {{-- Loop melalui data produk dari controller --}}
