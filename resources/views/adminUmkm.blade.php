                        ...
                        @endphp
                            @foreach ($paginatedItems as $item)
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        @if ($item->no_pirt != '-')
                                            <div class="badge bg-indigo-100 text-indigo-400 font-semibold border-0">
                                                P-IRT
                                            </div>
                                        @endif
                                        @if ($item->no_nib != '-')
                                        ...
                                        @endif
                                        @if ($item->no_halal != '-')
                                            <div class="badge bg-green-100 text-green-400 font-semibold border-0">HALAL
                                            </div>
                                        @endif
                                    </td>
                                    <td class="px-6 py-4">
                        ...
                        <form method="POST" action="{{ route('admin.umkm-desa.update') }}"
                            ...
                            <div class="form-control gap-6">
                                ...
                                <div class="flex gap-4 w-full">
                                    ...
                                    <div class="form-control gap-4 w-full">
                                        <label for="jam_buka_umkm_up" class="label-text font-semibold">Jam
                                            Buka</label>
                                ...
                                <div class="form-control gap-4">
                                    ...
                                    <input type="text" name="no_pirt" id="pirt_umkm_up"
                                        class="input input-bordered">
                                    <p class="label-text text-gray-500">opsional</p>
                                </div>
                                <div class="flex gap-4 w-full">
