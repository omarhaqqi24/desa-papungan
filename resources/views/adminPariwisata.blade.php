                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex gap-6 justify-center items-center">
                                        <button onclick="openModalDeletePariwisata('{{ $item->id }}')" class="font-medium">
                                    ...
                                    <dialog id="mdpr_{{ $item->id }}" class="modal">
                                        <div class="modal-box">
                                            ...
                                            <div class="modal-action">
                                                ...
                                                <button onclick="document.getElementById('mdpr_' + '{{ $item->id }}').close()" class="btn bg-secondary text-white">Tidak</button>
                                            </div>
                                        </div>
                                    </dialog>    
                                </td>
