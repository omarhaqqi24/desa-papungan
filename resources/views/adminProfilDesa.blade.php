        ...
        <x-admin-show forValue="PD-01" judulPenjelasan="Penjelasan"
            ...
            <div class="flex justify-end px-5 mt-4">
                ...
                <button class="btn text-lightText bg-secondary hover:bg-blue-900 px-4 py-2 rounded flex items-center"
                    onclick="document.getElementById('g').showModal();">
            ...
            <x-modalpf
                judul="Test"
                idModal="g"
                judulPenjelasan="Test Penjelasan"
                namaInputTextarea="test1"
                subJudulPenjelasan="Test Sub Judul"
                namaInputFoto="test3"
                valueTextarea="{{ $data->data->penjelasan }}"
                valueFoto="{{ $data->data->foto }}"
                actionUrl="/your-update-url"
                method="PUT"
            />
